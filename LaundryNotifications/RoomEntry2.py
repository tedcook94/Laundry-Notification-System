...
ROW = [31,33,35,37]				# pinout for RPi 2
COL = [32,36,38,40]
...
f = open("/home/pi/LaundryNotifications/DryerValues.py", "w")     
...
for i in range(0,31):
	...
	dryerXvalues.append(axes['x'])
	dryerYvalues.append(axes['y'])
	dryerZvalues.append(axes['z'])
	i += 1
	sleep(10)

print "X values for autocalibration: " + str(dryerXvalues)
print "Y values for autocalibration: " + str(dryerYvalues)
print "Z values for autocalibration: " + str(dryerZvalues)
print " "

xmin = min(dryerXvalues)
xmax = max(dryerXvalues)
ymin = min(dryerYvalues)
ymax = max(dryerYvalues)
zmin = min(dryerZvalues)
zmax = max(dryerZvalues)
...
def accelerometer():
	...
	from DryerValues import xmin
	from DryerValues import xmax
	from DryerValues import ymin
	from DryerValues import ymax
	from DryerValues import zmin
	from DryerValues import zmax
	...
	while(True):
		...
		# Room 0	
					if MATRIX[i][j] == 0:
						...
						if confirmentry() == 1:
							...
							confirmtext(Room0)
							if accelerometer() == 1:
								print "Dryer notification sent to room 0. (" + strftime("%H:%M") + ") [" + str(axes['x']) + ", " + str(axes['y']) + ", " + str(axes['z']) + "]"
								alerttext(Room0)
						elif confirmentry() == 0:
		...
		# Room 1
						...
						if confirmentry() == 1:
							...
							confirmtext(Room1)
							if accelerometer() == 1:
								print "Dryer notification sent to room 1. (" + strftime("%H:%M") + ") [" + str(axes['x']) + ", " + str(axes['y']) + ", " + str(axes['z']) + "]"
								alerttext(Room1)
						elif confirmentry() == 0:
							print "Entry cancelled. (" + strftime("%H:%M") + ")"
						else:
		...
		# Room 2	
						...
						if confirmentry() == 1:
							...
							confirmtext(Room2)
							if accelerometer() == 1:
								print "Dryer notification sent to room 2. (" + strftime("%H:%M") + ") [" + str(axes['x']) + ", " + str(axes['y']) + ", " + str(axes['z']) + "]"
								alerttext(Room2)
						elif confirmentry() == 0:
							print "Entry cancelled. (" + strftime("%H:%M") + ")"
						else:
		...
		# Room 3	
						...
						if confirmentry() == 1:
							...
							confirmtext(Room3)
							if accelerometer() == 1:
								print "Dryer notification sent to room 3. (" + strftime("%H:%M") + ") [" + str(axes['x']) + ", " + str(axes['y']) + ", " + str(axes['z']) + "]"
								alerttext(Room3)
						elif confirmentry() == 0:
							print "Entry cancelled. (" + strftime("%H:%M") + ")"
						else:
		...
		# Room 4	
						...
						if confirmentry() == 1:
							...
							confirmtext(Room4)
							if accelerometer() == 1:
								print "Dryer notification sent to room 4. (" + strftime("%H:%M") + ") [" + str(axes['x']) + ", " + str(axes['y']) + ", " + str(axes['z']) + "]"
								alerttext(Room4)
						elif confirmentry() == 0:
							print "Entry cancelled. (" + strftime("%H:%M") + ")"
						else:
		...
		# Room 5	
						...
						if confirmentry() == 1:
							...
							confirmtext(Room5)
							if accelerometer() == 1:
								print "Dryer notification sent to room 5. (" + strftime("%H:%M") + ") [" + str(axes['x']) + ", " + str(axes['y']) + ", " + str(axes['z']) + "]"
								alerttext(Room5)
						elif confirmentry() == 0:
							print "Entry cancelled. (" + strftime("%H:%M") + ")"
						else:
		...
		# Room 6	
						...
						if confirmentry() == 1:
							...
							confirmtext(Room6)
							if accelerometer() == 1:
								print "Dryer notification sent to room 6. (" + strftime("%H:%M") + ") [" + str(axes['x']) + ", " + str(axes['y']) + ", " + str(axes['z']) + "]"
								alerttext(Room6)
						elif confirmentry() == 0:
							print "Entry cancelled. (" + strftime("%H:%M") + ")"
						else:
		...
		# Room 7	
						...
						if confirmentry() == 1:
							...
							confirmtext(Room7)
							if accelerometer() == 1:
								print "Dryer notification sent to room 7. (" + strftime("%H:%M") + ") [" + str(axes['x']) + ", " + str(axes['y']) + ", " + str(axes['z']) + "]"
								alerttext(Room7)
						elif confirmentry() == 0:
							print "Entry cancelled. (" + strftime("%H:%M") + ")"
						else:
		...
		# Room 8	
						...
						if confirmentry() == 1:
							...
							confirmtext(Room8)
							if accelerometer() == 1:
								print "Dryer notification sent to room 8. (" + strftime("%H:%M") + ") [" + str(axes['x']) + ", " + str(axes['y']) + ", " + str(axes['z']) + "]"
								alerttext(Room8)
						elif confirmentry() == 0:
							print "Entry cancelled. (" + strftime("%H:%M") + ")"
						else:
